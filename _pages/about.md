...
I think a lot about our various higher-order cognitive processes and ways to understand their neural and computational underpinnings. I ask questions such as: how do we use memories to make [causal inferences](https://www.biorxiv.org/content/10.1101/2025.03.12.642853v1) when comprehending events? how do multiple experiences shape our preference and how do we use that to guide behavior? how do we make snap judgments about about other people but gradually update them over time? I use behavioral experiments, fMRI, and simulations of neural network models to answer these questions.
